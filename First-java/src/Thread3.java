...
public class Thread3 {
    ...
    public static void main(String[] args) {
         ...
         *   => 우선순위는 1 ~ 10 까지 범위의 정수 사용
         *   => 자주 사용되는 우선순위 값을 Thread 클래스의 상수로 제공
         *      MAX_PRIORITY : 10(높음)
         *      NORM_PRIORTTY : 5(보통) => 기본값
         *      MIN_PRIORITY : 1(낮음)
         *
         ...
         *      - 지정된 시간만큼 정확히 sleep 후에 복귀하는게 아니라
         *      쓰레드 상태 저장 및 지원 교환에 필요한 시간이 추가되므로
        ...
        t2.setPriority(Thread.MAX_PRIORITY); // 우선순위 10로 변경
