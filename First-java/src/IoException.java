...
public class IoException {
        ...
        public static void main(String[] args) {
             ...
             *      => FileInputStream, FileReader, BufferInputStream, BufferedReader 등
             *
             *    2. 출력 스트림 : 자바에서 데이터가 출력될 때 처리하는 스트림
             *      ex) 편집 화면에 사용자가 쓴 글을 파일에 저장할 때 사용
             *      => FileOutputStream, FileWriter, BufferOutputStream, BufferedWriter 등
             *
             *    - 스트림은 단방향통신만 가능하기 때문에 입력과 출력을 동시에 수행하려면
             *      입력을 위한 입력스트림 (input stream) 과 출력을 위한 출력스트림(output stream)의 2개의 스트림이 필요하다.
             *
             ...
             *  => InputStreamReader, OutputStreamWriter, BufferdInputStream,
             ...
             *     => Syetem.out : 표준 출력을 담당(모니터로 출력 가능)
             ...
             *  - 아무리 많은 데이터가 입력되어도 read() 메서드는 한번에 1Byte만
             *    처리되므로 더 많은 데이터나 더 큰 단위 처리가 불가능!
             *    => 영문 또는 숫자 등의 데이터 글자만 처리 가능
...
//       int n = is.read(); // 입력스트림 데이터중 1Byte 만큼의 데이터를 읽어 변수에 저장
...
//
             ...
             *  - 기본적으로 자원을 사용하는 객체 (Connection, InputStream 등)는 사용후
            ...
            // try 문의 소괄호() 내부에 예외처리가 필요한 객체의 생성 코드 작성
...
//      }
            ...
            try (InputStream is = System.in){
                ...
                // 반복문을 사용하여 더 이상 읽어올 데이터가 없을때까지 입력을 처리
