public class wrapper_class2 {
        ...
        public static void main(String[] args) {
            ...
            System.out.println(Integer.max(n1, n2));  // Wrapper 클래스타입 모두 사뇽 가능
            ...
            // Integer.toxXXString() 메서드를 호출하여 해당 진법으로 변환가능

            // -> XXX 은 각 진법명 지정(2진법 : Binary, 8진법 : Octalm 16진법 : Hex
            ...
            //입력받은 문자 ch에 대해 대문자, 소문자, 숫자, 기타문자 판별
            // => 대문자 : 문자 ch가 'A(65)' 이상이고,문자 ch가 'Z'이하일때
            if (ch >= 'A' && ch <= 'Z') {
